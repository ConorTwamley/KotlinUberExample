package com.conor.kotlinuberclone
...
import com.conor.kotlinuberclone.Model.DriverInfoModel
...
class SplashScreenActivity : AppCompatActivity() {
    ...
    private fun showRegisterLayout() {
        ...
        val itemView = LayoutInflater.from(this).inflate(R.layout.layout_regiser, null)
